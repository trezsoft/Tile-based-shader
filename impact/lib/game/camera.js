        ...
        Camera = ig.Class.extend(
            {
                ...
                set:function (entity, bottomLeft, topRight) {
                    ...
                    this.minX = bottomLeft.pos.x;
                    this.minY = topRight.pos.y;
                    this.maxX = topRight.pos.x + topRight.size.x - (ig.system.width);
                    this.maxY = bottomLeft.pos.y + bottomLeft.size.y - (ig.system.height);
                },

                follow:function (entity) {
                    this.pos.x = this.move('x', entity.pos.x, entity.size.x).limit(this.minX, this.maxX);
                    this.pos.y = this.move('y', entity.pos.y, entity.size.y).limit(this.minY, this.maxY);
